...
public:
    ...
    void setAdbTraceEnabled(bool enabled) { m_adbTransceiver.setTraceEnabled(enabled); }
    [[nodiscard]] std::vector<devices::adb::AdbTransceiver::TraceEvent> adbTraceEvents() const { return m_adbTransceiver.traceEvents(); }
    struct IoStatistics {
