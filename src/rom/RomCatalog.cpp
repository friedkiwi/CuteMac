...
QVector<RomDefinition> RomCatalog::definitions()
{
    return {
        ...
        { QStringLiteral("quadra700-420dbff3"), QStringLiteral("Macintosh Quadra 700/900"), RomKind::Machine, QStringLiteral("quadra-700"), QStringLiteral("420DBFF3"), 1024 * 1024, QByteArray::fromHex("c2093476e9c9a7d76973910a91fbfba23ca71163b84eb2623adf8608a6b03ed2"), {}, {}, 10, false },
